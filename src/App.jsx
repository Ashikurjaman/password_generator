  ...
  return (
    <>
      <div className='w-max max-h-max mx-auto shadow-md round-lg px-4 py-3 bg-gray-800 text-orange-700'>
        <h1 className='text-white text-center my-3 text-6xl'>Password Generator</h1>
        ...
        <div className='flex shadow-lg overflow-hidden mb-4'>
            ...
            readOnly
            />
            <button className='outline-none bg-blue-700 text-white px-3 py-0.5 shrink-0 text-xl'>
              Copy
            </button>
        </div>
        ...
        <div className='flex text-sm gap-x-2'>
          ...
          <div className=''>
            ...
            />
            <label htmlFor='charOn' className='text-xl'>Character</label>
          </div>
